...
- (IBAction)LoginButton:(id)sender {
    ...
    if ([self validateWithUser:_userNameTextField.text andPass:_passWordTextField.text andServer:_severTextField.text]) {
        ...
        [defaults setObject:self.severTextField.text forKey:SERVER];
        //保存
